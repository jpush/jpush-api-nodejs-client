...
function setOptions (sendno, time_to_live, override_msg_id, apns_production, big_push_duration, apns_collapse_id, third_part_channel) {
  if (sendno == null && time_to_live == null && override_msg_id == null && apns_production == null &&
    big_push_duration == null && third_part_channel == null) {
