...
function setNotification_3rd (title, content, channel_id, uri_activity, uri_action, badage_add_num, badge_class, sound, extras) {
  if (content == null || typeof content !== 'string') {
    throw new JError.InvalidArgumentError('notification_3rd.content is require and can only be set to the String')
  }
  var notification_3rd = {
    'content': content
  }

  if (title != null) {
    if (typeof title !== 'string') {
      throw new JError.InvalidArgumentError('Invalid notification_3rd.title, it can only be set to the String')
    }
  ...
  if (channel_id != null) {
    if (typeof channel_id !== 'string') {
      throw new JError.InvalidArgumentError('Invalid notification_3rd.channel_id, it can only be set to the String')
    }
  ...
  if (uri_activity != null) {
    if (typeof uri_activity !== 'string') {
      throw new JError.InvalidArgumentError('Invalid notification_3rd.uri_activity, it can only be set to the String')
    }
  ...
  if (uri_action != null) {
    if (typeof uri_action !== 'string') {
      throw new JError.InvalidArgumentError('Invalid notification_3rd.uri_action, it can only be set to the String')
    }
    notification_3rd['uri_action'] = uri_action
  }

  if (badage_add_num != null) {
    if (typeof badage_add_num !== 'string') {
      throw new JError.InvalidArgumentError('Invalid notification_3rd.badage_add_num, it can only be set to the String')
    }
    notification_3rd['badage_add_num'] = badage_add_num
  }

  if (badge_class != null) {
    if (typeof badge_class !== 'string') {
      throw new JError.InvalidArgumentError('Invalid notification_3rd.badge_class, it can only be set to the String')
    }
  ...
  if (sound != null) {
    if (typeof sound !== 'string') {
      throw new JError.InvalidArgumentError('Invalid notification_3rd.sound, it can only be set to the String')
    }
  ...
  if (extras != null) {
    if (typeof extras !== 'object') {
      throw new JError.InvalidArgumentError('Invalid notification_3rd.extras, it can only be set to JSON Object')
    }
