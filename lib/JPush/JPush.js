...
exports.buildClient = function(appKey, masterSecret, retryTimes, isDebug, readTimeout) {
    if (arguments.length == 1 && typeof arguments[0] == 'object') {
        ...
        return new JPushClient(options.appKey, options.masterSecret, options.retryTimes, options.isDebug, options.readTimeout);
    } else {
...
function sendPush(payload, callback) {
    ...
    }, 'POST', 1, this.retryTimes, this.isDebug, this.readTimeout, callback);
}
...
function getReportReceiveds(msg_ids, callback) {
    ...
    return _request(url, null, header, {
        user : this.appkey,
        pass : this.masterSecret
    }, 'GET', 1, this.retryTimes, this.isDebug, this.readTimeout, callback);
}
...
function deleteTag(theTag, platform, callback) {
    ...
    return _request(url, null, header, {
        user : this.appkey,
        pass : this.masterSecret
    }, 'delete', 1, this.retryTimes, this.isDebug, this.readTimeout, callback);
}
...
function _request(url, body, headers, auth, method, times, maxTryTimes, isDebug, readTimeout, callback) {
    if (isDebug) {
        ...
        if (err) {
            ...
            if (times < maxTryTimes) {
                return _request(url, body, headers, auth, method, times + 1,
                        maxTryTimes, isDebug, readTimeout, callback);
            } else {
                return callback(new JError.APIConnectionError(
